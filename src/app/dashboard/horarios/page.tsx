    ...
    <main className="p-6 text-gray-800">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-2">
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-all duration-300"
        >
      ...
      {schedules.length > 0 ? (
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {schedules.map((item) => (
            <div
              key={item.id}
              className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transform transition-all duration-300"
            >
              ...
              <div className="flex justify-end mt-6 space-x-2">
                <button
                  ...
                  className="flex items-center gap-1 bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded-lg transition-all duration-300"
                >
                  <PencilIcon className="w-5 h-7" />
                </button>
                <button
                  onClick={() => handleDelete(item)}
                  className="flex items-center gap-1 bg-red-500 hover:bg-red-600 text-white font-bold py-1 px-3 rounded-lg transition-all duration-300"
                >
